...
export default function ContactHero() {
  ...
  <h1 className="mt-4 text-[40px] leading-[1.12] sm:text-6xl font-black font-semibold tracking-tight text-neutral-900">
    ...
    <br />
    <span className="text-[#3B66F6]">Trading Workflow</span>
  </h1>

  {/* Subtext */}
  <p className="mt-4 max-w-xl mx-auto text-[14.5px] sm:text-[15px] text-neutral-600">
    Have a question about the platform or need help setting up your workflow?
    <br className="hidden sm:block" />
    Our team is here to assist with account setup, integrations, and general guidance.
    Reach out anytime and we will help you get started smoothly.
  </p>
